#!/usr/bin/env python3
# Hacked By HideHacker

# HideHacker @Protonmail.CoM
...
def crimeflare(target):
    ...
    if (len(crimeFoundArray) != 0):
        for foundIp in crimeFoundArray:
            print_out(Style.BRIGHT + Fore.RED + "[By HideHacker ;-) FOUND:IP] " + Fore.GREEN + "" + foundIp.strip())
    else:
...
def init(target):
    if args.target:
        ...
        print_out (Fore.RED + "perl cloudhide.py --target Site.CoM")
        sys.exit(1)
...
logo = """\
   ...
   db   db d888888b d8888b. d88888b db   db  .d8b.   .o88b. db   dD d88888b d8888b.
   88   88   `88'   88  `8D 88'     88   88 d8' `8b d8P  Y8 88 ,8P' 88'     88  `8D
   88ooo88    88    88   88 88ooooo 88ooo88 88ooo88 8P      88,8P   88ooooo 88oobY'
   88~~~88    88    88   88 88~~~~~ 88~~~88 88~~~88 8b      88`8b   88~~~~~ 88`8b  
   88   88   .88.   88  .8D 88.     88   88 88   88 Y8b  d8 88 `88. 88.     88 `88.
   YP   YP Y888888P Y8888D' Y88888P YP   YP YP   YP  `Y88P' YP   YD Y88888P 88   YD

                               HideHacker Is Iranian
                      Coder by N3TROOT3R  - CloudHide.py  v 0.1
                     Example : perl cloudhide.py --target Site.CoM    
"""

print(Fore.RED + Style.BRIGHT + logo + Fore.RESET)
datestr = str(datetime.datetime.strftime(datetime.datetime.now(), '%d/%m/%Y'))
print_out("Initializing CloudHide - the date is: " + datestr)
